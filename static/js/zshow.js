define(function (require, exports, module){
    ...
    $.extend({
        ...
        zClose: function(o) {
            ...
            $('body').css({'overflow-y':'scroll','height':'auto'})//出现滚动条
            //$(o).find(".btn").remove();
            $(".bgdiv").fadeOut(10,
                function() {
                    $(this).remove()
        ...
        zShow: function(options) {
            ...
            if (top.location == self.location) {
                ...
                if ((parseInt(pos_y) - parseInt($(parent.document).find("iframe:eq(0)").offset().top) + parseInt($me.oH())) >= parseInt($.docH())) {
                    ...
                    if (top.location != self.location) {
                        pos_y = parseInt(pos_y) - parseInt($(parent.document).find("iframe:eq(1)").offset().top)
                    }
                }
            }
            if (pos_y <= 10) {
            ...
            $('body').css({'height':'100%','overflow-y':'hidden'})//防止出现滚动条
            ...
            if (sets.Scroll) {
                ...
                $(owin).scroll(function() {
                    if (top.location != self.location) {
                        y = $(parent.document).find("iframe:eq(1)").offset().top;
            ...
            $me.children(".closePop").bind("click", function() {
                ...
                switch (sets.types) {
                    case 3:
                        $(this).remove();
                        $me.animate({
                                "left": $(sets.obj).eq(sets.io).offset().left + "px",
